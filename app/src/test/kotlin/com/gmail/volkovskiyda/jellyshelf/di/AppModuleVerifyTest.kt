 ...
 * - [AppNavKey.Player] — the player ViewModel's single runtime param: which video, opened from
 *   which list. Nothing in the graph *provides* a nav key, so whitelisting it cannot mask a real
 *   missing binding.
