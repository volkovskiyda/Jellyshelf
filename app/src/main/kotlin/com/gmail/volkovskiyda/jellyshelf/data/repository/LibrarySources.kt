 ...
 *
 * [DefaultLibraryRepository] merges four origins — the Jellyfin server, the hosted metadata index,
 * the in-app yt-dlp extractor, and the stand-in that serves demo installs — and taking them
 * individually made its constructor a list of interchangeable-looking sources. Grouped, the
 * repository reads as what it is: a database, the places its contents come from, settings, and
 * dispatchers.
 *
