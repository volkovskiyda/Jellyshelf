 ...
 *
 * Duplicated from src/testShared/kotlin: the screenshot plugin registers no AndroidSourceSet, so
 * build.gradle.kts cannot add that shared directory to this compilation. Keep both in sync, and
 * collapse them when the plugin exposes its source set.
 *
